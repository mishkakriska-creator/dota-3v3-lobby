const CACHE='dota-cards-shell-v6';
const CORE=['./','./index.html','./style.css?v=18790','./visual-fixes.css?v=18870','./game.js?v=18850','./profile.js?v=18820','./network.js?v=18790','./lifecycle.js?v=18820','./assets/dota_app_icon.png','./assets/dota_app_icon_192.png'];
